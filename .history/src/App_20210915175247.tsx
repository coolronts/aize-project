...
const App: React.FunctionComponent = () => {
  ...
  const updateSelectedProduct = (product: IProduct|null)=>{
    setSelectedProduct(product)
  }

  const updateIsEdit = (type:string)=>{
    setIsEdit(type)
  }
  ...
  const commonContextValues = {selectedProduct, updateSelectedProduct, isLoading, isError, updateIsError, updateIsLoading, allProducts,  getAllProducts, isEdit, updateIsEdit}
