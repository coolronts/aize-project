...
const App: React.FunctionComponent = () => {
  ...
  const commonContextValues = {selectedProduct, updateSelectedProduct, isLoading, isError, updateIsError, updateIsLoading, allProducts,  getAllProducts, isEdit, updateIsEdit, isAdd, setIsAdd}
