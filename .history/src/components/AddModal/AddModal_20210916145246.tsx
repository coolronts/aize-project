...
const AddModal: React.FunctionComponent = () => {
  ...
  const { register, handleSubmit, watch,control, formState: { errors,isDirty, isSubmitting, touchedFields, submitCount  } } = useForm<IProduct>();
    ...
    <section className={styles.container}>
        <div className={styles.modal}>
          ...
          <input defaultValue="" {...register("images")} />
            ...
            <div className={styles.inputGroup}>
              <label>Image  </label>
              <Controller control={control} name="defaultImage" as={<input onChange={(e)=>uploadImage(e)}  type="file"  accept=".jpeg, .png, .jpg"/>}/>
