        ...
        <div className={styles.card}>
          {role ==='ADMIN'?
            <>
              ...
              <div className={styles.imageContainer}><FaEdit onClick={()=>{commonContext.updateIsEdit('image');selectProduct(product)}}/><img src={product.defaultImage} alt="product"/></div>
