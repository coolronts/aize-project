    ...
    <section>
      <div className={styles.container}>
        ...
        {role ==='ADMIN'?
          ...
          <div className={styles.imageContainer}><FaEdit onClick={()=>{commonContext.updateIsEdit('discount');selectProduct(product)}}/><img src={product.defaultImage} alt="product"/></div>
