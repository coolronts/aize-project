        ...
        <div className={styles.card}>
          ...
          {role ==='ADMIN'?
            ...
            <div className={styles.adminControl}>
              ...
              <h2 className={styles.description}><FaEdit onClick={()=>{commonContext.updateIsEdit('name');selectProduct(product)}} className={styles.icon}/>{product.description}</h2>
              <h3 className={styles.price}><FaEdit onClick={()=>{commonContext.updateIsEdit('name');selectProduct(product)}} className={styles.icon}/>{product.price} <span>NOK</span></h3>
