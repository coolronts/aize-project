  ...
  return( 
    <section>
      <div className={styles.container}>
        {role ==='ADMIN'?
          <>
            <div className={styles.discount}> <FaHashtag/> <FaTags/>  {product.discount} <FaPercentage/>  <FaEdit onClick={()=>{commonContext.updateIsEdit('discount');selectProduct(product)}}/> </div>
        ...
        :
          <>           
               <FaTags style={{boxShadow: "0 5px 10px rgba(146, 61, 36, 0.05), 0 15px 40px rgba(165, 83, 63, 0.2)"}} className={styles.discount}>  {product.discount} <FaPercentage/> </FaTags>   
